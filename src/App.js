        ...
        <div className="container content">
          <div className="columns is-centered">
            <div className="column is-half">
              ...
              <br />
              <AudioPlayer
                src="https://san-movies.b-cdn.net/videos/india-sg2.mp3"
              ...
              <Fade>
                <p className="has-text-success has-text-weight-bold has-text-centered">
                  My Personal Wishing web page for Sharing My Greetings and
                  Wishes Around the World - Built using React JS <br />
                  <br />
                  <img
                    src="./react.png"
                    loading="lazy"
